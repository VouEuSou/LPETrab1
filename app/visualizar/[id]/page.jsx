  ...
  <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z"/>
        ...
        <form encType="multipart/form-data">
          ...
          <div className="row mt-3">
            ...
            <img src={album.capa} id="capa" alt={`Capa do álbum ${album.capa}`} width={200} height={200} className="mx-auto d-block" />
          </div>
          </div>

          <div className="col d-flex justify-content-end mt-4">
          <Link className="btn btn-success float-end" href={`/modificar/${params.id}`} >Editar informações</Link>
          </div>
        </form>
      </div>
    </div>
